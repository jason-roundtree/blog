...
function KeywordTags(props) {
  ...
  return __jsx("div", {
    ...
    return tag.count && __jsx(TagBtn, {
      ...
      id: tag._id,
      onClick: props.handleTagFilter,
      className: props.filteredTags.includes(tag._id) || props.filteredTags.length === props.tags.length ? 'selectedTag' : '',
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 42,
...
//# sourceMappingURL=index.js.926e37b008bc7820c9df.hot-update.js.map