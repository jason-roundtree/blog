...
})(["padding:1em 40px;background:rgb(250,223,147);display:flex;justify-content:space-between;"]);
...
})(["font-weight:normal;font-size:2em;display:inline-block;"]);
var ToggleCircle = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].span.withConfig({
  displayName: "HeaderLayout__ToggleCircle",
  componentId: "sc-2bs9km-2"
})(["height:25px;width:25px;background-color:", ";border-radius:50%;display:inline-block;vertical-align:middle;box-shadow:0 0 10px 2px rgba(0,0,0,0.6);"], function (_ref) {
...
function HeaderLayout(props) {
  ...
  }, "Jason Roundtree"))), __jsx(ToggleCircle, {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
...
//# sourceMappingURL=index.js.bc4578e1381768f21087.hot-update.js.map