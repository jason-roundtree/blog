...
function Index(_ref) {
  ...
  function getTagCountsData() {
    return Promise.all(tags.map(function (tag) {
      return _client__WEBPACK_IMPORTED_MODULE_2__["default"].fetch("\n                    *[ _id == $tagID ]{\n                        name,\n                        _id,\n                        \"tagCount\": count(\n                            *[ _type == \"post\" && $tagID in tags[]._ref ]\n                        )\n                    }\n                ", {
        tagID: tag._id
      });
    }));
  }
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    getTagCountsData().then(function (tagCounts) {
      console.log('tagCountssdss: ', tagCounts);
      setTagCounts.apply(void 0, Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(tagCounts));
    })["catch"](function (err) {
...
//# sourceMappingURL=index.js.c22feda0e76ae7dbebf0.hot-update.js.map