...
function Index(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    allPosts.forEach(function (post) {
      post.tags.forEach(function _callee(tag) {
        var count, tagCount;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                console.log('tagCount: ', tagCount); // setTagCounts(...tagCounts, tagCount)

                if (!tagCounts.includes(tagCount.toString())) {
  ...
  function getFilteredPosts() {
    var posts;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function getFilteredPosts$(_context2) {
      while (1) {
...
//# sourceMappingURL=index.js.2f4d5d8806cd334ff44a.hot-update.js.map