...
function Index(_ref) {
  ...
  console.log('tagCounts global: ', filteredPosts);

  function getTagCountsData() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getTagCountsData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", Promise.all(tags.map(function (tag) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    getTagCountsData().then(function (postsArray) {
      console.log('result: ', postsArray);
      var flattenedArrayOfPosts = postsArray.flatMap(function (posts) {
        return posts;
      });
      console.log('flattenedArrayOfPosts: ', flattenedArrayOfPosts);
      setTagCounts(uniquePostsArray(flattenedArrayOfPosts));
    })["catch"](function (err) {
...
//# sourceMappingURL=index.js.9bdd13f0e36e867f318e.hot-update.js.map