...
function Post(props) {
  ...
  function formatAsideStringIntoNewlines(content, key) {
    var contentArray = content.split('\n');
    console.log('contentArray: ', contentArray); // return <AsideBlock key={key}>{content}</AsideBlock>
  }
  ...
  props.body && props.body.forEach(function (section) {
    ...
    if (section._type === 'block') {
      ...
      postContent.push(formatAsideStringIntoNewlines(section.string_content, section._key));
    }
  });
...
//# sourceMappingURL=[slug].js.a3902ab21971887994e2.hot-update.js.map