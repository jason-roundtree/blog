...
})(["border:none;padding:.75em 1em;opacity:.75;background-color:var(--secondary-color);position:fixed;bottom:25px;left:50%;transform:translateX(-50%);&:hover{cursor:pointer;background-color:var(--primary-darker);color:var(--secondary-color);}"]);
...
function Post(props) {
  ...
  return __jsx(_components_HeaderLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    return content;
  }))), showBackToTopBtn && __jsx(BackToTopBtn, {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 206,
...
//# sourceMappingURL=[slug].js.01831e0d3892479f058c.hot-update.js.map