...
})(["border:none;padding:.75em 1em;opacity:.75;background-color:", ";color:", ";left:50%;transform:translateX(-50%);&:hover{cursor:pointer;background-color:var(--primary-darker);color:", ";}"], function (_ref5) {
  ...
  function prismafyCodeBlock(content, _key) {
    ...
    return __jsx(prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__["defaultProps"], {
      ...
      var className = _ref8.className,
          style = _ref8.style,
          tokens = _ref8.tokens,
          getLineProps = _ref8.getLineProps,
          getTokenProps = _ref8.getTokenProps;
      return __jsx(Pre, {
        className: className,
        style: style,
        __self: _this,
...
//# sourceMappingURL=[slug].js.42abe1525c854f1f143b.hot-update.js.map