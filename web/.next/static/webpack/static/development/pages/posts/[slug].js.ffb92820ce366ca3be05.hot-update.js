...
})(["border:none;padding:.75em 1em;opacity:.75;background-color:", ";color:", ";position:fixed;bottom:25px;left:50%;transform:translateX(-50%);&:hover{cursor:pointer;background-color:var(--primary-darker);color:var(--secondary-color);}"], function (_ref5) {
  ...
  function prismafyCodeBlock(content, _key) {
    ...
    return __jsx(prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prism_react_renderer__WEBPACK_IMPORTED_MODULE_4__["defaultProps"], {
      ...
      var className = _ref7.className,
          style = _ref7.style,
          tokens = _ref7.tokens,
          getLineProps = _ref7.getLineProps,
          getTokenProps = _ref7.getTokenProps;
      return __jsx(Pre, {
        className: className,
        style: style,
        __self: _this,
...
//# sourceMappingURL=[slug].js.ffb92820ce366ca3be05.hot-update.js.map