...
var AsideBlockNewline = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "slug__AsideBlockNewline",
  ...
  function asideStringNewlines(content, key) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        renderedLines.push(__jsx(AsideBlockNewline, {
          __self: this,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 66,
    ...
    return renderedLines; // return <AsideBlock key={key}>{content}</AsideBlock>
  }
...
//# sourceMappingURL=[slug].js.d80cdc3d368a55ce6f57.hot-update.js.map