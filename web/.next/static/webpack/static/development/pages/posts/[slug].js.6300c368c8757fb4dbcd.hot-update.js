...
function Post(props) {
  ...
  function paragraphBlock(section) {
    ...
    for (var _i = 0; _i < section.children.length; _i++) {
      if (section.children[_i].marks.length > 0) {
        for (var j = 0; j < section.markDefs.length; j++) {
          if (section.markDefs[j]._key === section.children[_i].marks[0]) {
            ...
            }, section.children[_i].text));
          }
        }
      } else {
        blockContent.push(section.children[_i].text);
      }
...
//# sourceMappingURL=[slug].js.6300c368c8757fb4dbcd.hot-update.js.map