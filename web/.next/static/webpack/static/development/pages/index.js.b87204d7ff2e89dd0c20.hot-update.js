...
function Index(_ref) {
  ...
  function handleTagFilter(e) {
    console.log('e: ', e.target.id); // TODO: why exactly is `data` needed here and where does it come from?

    var selectedTagID = e.target.id; // console.log('selectedKeyword: ', selectedKeyword)

    if (!filteredTags.includes(selectedTag)) {
      setFilteredTags([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(filteredTags), [selectedTag]));
    } else {
...
//# sourceMappingURL=index.js.b87204d7ff2e89dd0c20.hot-update.js.map