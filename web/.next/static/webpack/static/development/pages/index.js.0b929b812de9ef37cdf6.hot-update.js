...
function KeywordTags(props) {
  ...
  return __jsx("div", {
    ...
    return tag.count && __jsx(TagBtn, {
      ...
      id: tag._id,
      onClick: props.handleTagFilter,
      className: props.filteredTags.includes(tag._id) || props.filteredTags.length === props.tag ? 'selectedTag' : '',
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 42,
...
//# sourceMappingURL=index.js.0b929b812de9ef37cdf6.hot-update.js.map