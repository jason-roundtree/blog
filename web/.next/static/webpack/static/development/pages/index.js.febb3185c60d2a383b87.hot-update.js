...
function Index(_ref) {
  ...
  var tags = posts.reduce(function (tagCount, post) {
    ...
    post.tags && post.tags.forEach(function (tag) {
      if (!tagCount[tag.name]) {// tagCount[tag.name].count = 1
  ...
  }, "Tags:"), __jsx(_components_KeywordTags__WEBPACK_IMPORTED_MODULE_8__["default"] // tags={tagCountsArray}
  , {
...
//# sourceMappingURL=index.js.febb3185c60d2a383b87.hot-update.js.map