...
var TagListItem = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].li.withConfig({
...
var DescP = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].p.withConfig({
...
function Index(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    tags.forEach(function (tag) {
      var count = _client__WEBPACK_IMPORTED_MODULE_2__["default"].fetch("\n                count(*[ _type == \"post\" && $tagID in tags[]._ref ])\n            ", {
        tagID: tag._id
      ...
      count.then(function (data) {
        if (data > 0) {
          ...
          console.log('_tagCounts: ', _tagCounts); // TODO: what's a good way to set these all these at once??
          // setTagCounts(state => [...state, tagCount])
        }
      });
      setTagCounts(function (state) {
        return [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(state), [tagCount]);
      });
    });
  ...
  return __jsx(_components_HeaderLayout__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }, "Tags:"), __jsx(_components_KeywordTags__WEBPACK_IMPORTED_MODULE_7__["default"], {
    tags: tagCounts,
    ...
    }, moment__WEBPACK_IMPORTED_MODULE_5___default.a.utc(_createdAt).format("LL")), __jsx("ul", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 149,
...
//# sourceMappingURL=index.js.2a9999ab5014b7274fc5.hot-update.js.map