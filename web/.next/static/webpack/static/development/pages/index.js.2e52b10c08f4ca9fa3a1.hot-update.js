...
function Index(_ref5) {
  ...
  return (// TODO: is there a better way to render HeaderLayout instead of using in here and in [slug] (and any other separate pages that I add? Checkout next.js _document)
    __jsx(_components_HeaderLayout__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      }, props.manual_pub_date ? moment__WEBPACK_IMPORTED_MODULE_6___default.a.utc(props.manual_pub_date).format("LL") : moment__WEBPACK_IMPORTED_MODULE_6___default.a.utc(props._createdAt).format("LL")), __jsx("ul", {
        __self: _this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 166,
...
//# sourceMappingURL=index.js.2e52b10c08f4ca9fa3a1.hot-update.js.map