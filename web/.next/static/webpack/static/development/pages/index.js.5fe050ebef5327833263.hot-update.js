...
function Index(_ref) {
  ...
  function handleClickFilter(e) {
    var selectedKeyword = e.target.firstChild;
    setFilteredPosts([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(filteredKeywords), [selectedKeyword]));
    console.log('filteredKeywords: '); // const posts = await client.fetch(`
    //     *[ _type == "post" ]{
    //         ..., 
    //         tags[]->{_id, name}
    //     }
...
//# sourceMappingURL=index.js.5fe050ebef5327833263.hot-update.js.map