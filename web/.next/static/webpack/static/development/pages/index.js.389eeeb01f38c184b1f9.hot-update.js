...
var TagListItem = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].li.withConfig({
...
var DescP = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].p.withConfig({
...
function Index(_ref) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(tagCounts),
  ...
  console.log('tagCounts global: ', tagCounts); // async function getTagCountsData() {
  //     return Promise.all(
  //         tags.map(tag => {
  //             return client.fetch(`
  //                 *[ _id == $tagID ]{
...
//# sourceMappingURL=index.js.389eeeb01f38c184b1f9.hot-update.js.map